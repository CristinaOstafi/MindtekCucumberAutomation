@regression @ui @webOrder @orderCreation
Feature: Validating Order Creation
  ...
  Scenario Outline: Validating discount calculator
    When User selects "<product>" and quantity <quantity>
    ...
    Scenario: Validating Order Creation functionality
      And User creates order with data
        ...
        | FamilyAlbum | 10       | Harsh Patel   | 123 Dee St | Seattle | Washington    | 54321 | Visa | 346789345 | 06/25    |
